...
import { Merchant, MerchantFormData, SignupFormData } from './interface';
...
const merchantReducer = (state = initialState, action: any) => {
    switch (action.type) {
        ...
        case REMOVE_MERCHANT:
            const index = state.merchants.findIndex((b: Merchant) => b._id === action.payload);
            return {
                ...state,
                merchants: [
