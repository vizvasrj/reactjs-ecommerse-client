...
import { Review } from '../../../containers/Review/interface';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '../../../reducer';
import { ThunkDispatch } from 'redux-thunk';
import { ReviewActionTypes } from '../../../containers/Review/interface';
import { approveReview, deleteReview, rejectReview } from '../../../containers/Review/actions';
                            ...
                            <>
                                ...
                                <div className='d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mx-0'>
                                    <Button
                                        ...
                                        size='md'
                                        text='Approve'
                                        onClick={() => dispatch(approveReview(review))}
                                    />
                                    <Button
                                        className='mt-3 mt-lg-0'
                                        text='Delete'
                            ...
                            <div className='d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mx-0'>
                                <div className='d-flex flex-column flex-lg-row mx-0'>
                                    ...
                                    <Button
                                        ...
                                        size='md'
                                        text='Reject'
                                        onClick={() => dispatch(rejectReview(review))}
                                    />
                                </div>
                                <Button
                                    className='mt-3 mt-lg-0'
