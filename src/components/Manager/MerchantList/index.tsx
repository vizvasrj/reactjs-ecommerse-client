...
import { disableMerchant, approveMerchant, rejectMerchant, deleteMerchant } from '../../../containers/Merchant/actions';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '../../../reducer';
import { ThunkDispatch } from 'redux-thunk';
import { MerchantActionTypes } from '../../../containers/Merchant/interface';
import { Merchant } from '../../../containers/Merchant/interface';
...
interface MerchantListProps {
    ...
    disableMerchant: (merchant: Merchant, isActive: boolean) => void;
}
...
const MerchantList: React.FC<MerchantListProps> = ({
    ...
    const renderMerchantPopover = (merchant: Merchant) => (
        <div className='p-2'>
    ...
    //     dispatch(approveMerchant(merchant));
    // }

    // const handleRejectMerchant = (merchant: Merchant) => {
    //     dispatch(rejectMerchant(merchant));
    // }
            ...
            {merchants.map((merchant, index) => (
                <div key={index} className='merchant-box'>
                    <div className='mb-3 p-4'>
                        ...
                        <p>{formatDate(merchant.createdAt)}</p>
