...
const SocialShare: React.FC<SocialShareProps> = ({ product }) => {
    const shareMsg = `I ♥ ${product.name} product on Mern Store!  Here's the link, ${window.location.protocol !== 'https' ? 'http' : 'https'
