...
const BarsIcon = () => {
    return (
        ...
        >
            ...
            <path
                d='M3 12h18v2H3zm0-5h18v2H3zm0 10h18v2H3z'
                fill='currentColor'
            />
        </svg>
    );
...
const CloseIcon = () => {
    return (
        ...
        >
            <path d='M0 0h24v24H0z' fill='none' />
            <path
                d='M18.3 5.71a1 1 0 0 0-1.42 0L12 10.59 7.12 5.7a1 1 0 0 0-1.41 1.42L10.59 12l-4.88 4.88a1 1 0 0 0 1.41 1.41L12 13.41l4.88 4.88a1 1 0 0 0 1.41-1.41L13.41 12l4.88-4.88a1 1 0 0 0 0-1.41z'
                fill='currentColor'
            />
        </svg>
    );
