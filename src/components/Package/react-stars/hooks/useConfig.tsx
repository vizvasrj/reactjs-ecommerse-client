...
import { ReactStarsProps } from '../index';

export default function useConfig(config: ReactStarsProps): [ReactStarsProps, (config: ReactStarsProps) => void] {
    ...
    const configObj: ReactStarsProps = {
        count,
        size,
        char,
        color,
    ...
    function setConfig(config: ReactStarsProps): void {
